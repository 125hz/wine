...
/* iOS-Madeira ml1460: ACCEPT COMPLETION CHAIN. Device logs 171 and 181: the Windows
 * Steam client's listener accepted a second and third local connection from its
